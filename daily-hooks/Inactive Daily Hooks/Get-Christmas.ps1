...
$firstDayOfChristmas = "2024-12-11"; 	#MONDAY 12th (SUNDAY 11TH SO IT FITS!)
$finalDayOfChristmas = "2024-12-23"; 	#FRIDAY 23rd
...
#$today = Get-Date -Format "yyyy-MM-dd";
#TESTING BY DATE
$today = Get-Date -Year 2024 -Month 12 -Day 23 -Format "yyyy-MM-dd";
